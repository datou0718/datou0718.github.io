...
export const content = {
  ...
  bio: "I am a first-year Ph.D. student in the [CEI Lab](https://cei.pratt.duke.edu/) of the [Department of Electrical and Computer Engineering](https://ece.duke.edu/) at [Duke University](https://www.duke.edu/), advised by [Prof. Yiran Chen](https://ece.duke.edu/people/yiran-chen/). I enjoy exploring in-memory computing through algorithm-hardware co-design, accelerating various applications such as retrieval-augmented generation and tree-based machine learning. I had the privilege of working with [Prof. X. Sharon Hu](https://sites.nd.edu/xsharon-hu/) at the [University of Notre Dame](https://www.nd.edu/), [Prof. Tei-Wei Kuo](https://www.csie.ntu.edu.tw/~ktw/) and [Prof. Yuan-Hao Chang](https://www.csie.ntu.edu.tw/~johnson/) at [National Taiwan University](https://www.ntu.edu.tw/).",
  researchInterests: [
    "In-Memory Computing",
